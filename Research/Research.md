...
<sub> How does taxation affect portfolio choices? Leveraging a 2017 reform which transformed the French wealth tax into a real estate tax, I estimate the substitution between real estate and financial wealth once tax rates start to differ for both asset classes. To identify causal effects, I use comprehensive tax returns for France and a difference-in-differences design comparing French taxpayers to non-residents subject to the wealth tax but not affected by the policy change. Five years after the reform, the stock of real estate held by French taxpayers decreased by an average of 6%, with responses driven by investment rather than owner-occupied housing. The decrease in real estate held by French taxpayers is mirrored by a surge in dividend and interest income received after the reform, consistent with asset rebalancing responses to the differential tax change. Translating the reduced-form estimates into a cross-elasticity of 5, my results suggest that tax-driven reallocation between real estate and financial assets increased tax revenue losses associated with the reform by 30%. The main implication of my findings is that the optimal difference in rates between the two assets is lower than what the literature suggests when abracting from this portfolio reallocation mechanism. </sub>
